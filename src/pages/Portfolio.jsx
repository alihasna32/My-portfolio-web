    ...
    return (
        <main className="space-y-12">
            <div className="text-center">
                ...
                <p className="text-lg text-gray-600 dark:text-gray-400">A collection of my favorite projects.</p>
            </div>
            <div className="flex justify-center mb-8">
                <div className="flex space-x-2 bg-gray-200/50 dark:bg-gray-900/60 p-1.5 rounded-lg border border-gray-300 dark:border-gray-700">
                    <button className="px-4 py-2 text-sm font-medium text-white bg-primary rounded-md">All</button>
                    <button className="px-4 py-2 text-sm font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-300/50 dark:hover:bg-gray-800/50 rounded-md transition-colors">Web Development</button>
                    <button className="px-4 py-2 text-sm font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-300/50 dark:hover:bg-gray-800/50 rounded-md transition-colors">Mobile Apps</button>
                    <button className="px-4 py-2 text-sm font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-300/50 dark:hover:bg-gray-800/50 rounded-md transition-colors">UI/UX Design</button>
                </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div className="bg-gray-200/30 dark:bg-gray-900/40 rounded-lg border border-gray-300 dark:border-gray-700 overflow-hidden group transform hover:-translate-y-2 transition-transform duration-300">
                    <a href="#">
                        ...
                        <div className="p-6">
                            ...
                            <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">A full-stack e-commerce solution with a custom CMS and payment integration.</p>
                ...
                <div className="bg-gray-200/30 dark:bg-gray-900/40 rounded-lg border border-gray-300 dark:border-gray-700 overflow-hidden group transform hover:-translate-y-2 transition-transform duration-300">
                    <a href="#">
                        ...
                        <div className="p-6">
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Mobile Banking App</h3>
                            <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">Secure and intuitive mobile banking app for iOS and Android.</p>
                ...
                <div className="bg-gray-200/30 dark:bg-gray-900/40 rounded-lg border border-gray-300 dark:border-gray-700 overflow-hidden group transform hover:-translate-y-2 transition-transform duration-300">
                    <a href="#">
                        ...
                        <div className="p-6">
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">SaaS Dashboard Design</h3>
                            <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">A complete UI/UX overhaul for a data analytics SaaS platform.</p>
                ...
                <div className="bg-gray-200/30 dark:bg-gray-900/40 rounded-lg border border-gray-300 dark:border-gray-700 overflow-hidden group transform hover:-translate-y-2 transition-transform duration-300">
                    <a href="#">
                        ...
                        <div className="p-6">
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Travel Planning Website</h3>
                            <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">An interactive web application for planning and booking trips.</p>
                            <span className="text-xs font-semibold inline-block py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline bg-primary/20 text-primary rounded-full">Web Development</span>
                        </div>
                    </a>
                </div>
                <div className="bg-gray-200/30 dark:bg-gray-900/40 rounded-lg border border-gray-300 dark:border-gray-700 overflow-hidden group transform hover:-translate-y-2 transition-transform duration-300">
                    <a href="#">
                        ...
                        <div className="p-6">
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Health & Fitness Tracker</h3>
                            <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">A cross-platform mobile app to track workouts and nutrition.</p>
                            <span className="text-xs font-semibold inline-block py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline bg-green-500/20 text-green-400 rounded-full">Mobile Apps</span>
                        </div>
                    </a>
                </div>
                <div className="bg-gray-200/30 dark:bg-gray-900/40 rounded-lg border border-gray-300 dark:border-gray-700 overflow-hidden group transform hover:-translate-y-2 transition-transform duration-300">
                    <a href="#">
                        ...
                        <div className="p-6">
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Corporate Website Redesign</h3>
                            <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">Redesigning a major corporate website for better user engagement.</p>
                            <span className="text-xs font-semibold inline-block py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline bg-purple-500/20 text-purple-400 rounded-full">UI/UX Design</span>
                        </div>
                    </a>
                </div>
