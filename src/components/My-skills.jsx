    ...
    return (
        <div>
            <div className="bg-gray-200/30 dark:bg-gray-900/40 p-8 rounded-lg border border-gray-300 dark:border-gray-700">
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">My Skills</h2>
                    <div className="space-y-6">
                        <div>
                            <div className="flex justify-between mb-1">
                                <span className="text-base font-medium text-gray-700 dark:text-gray-300">React & JavaScript</span>
                        ...
                        <div>
                            <div className="flex justify-between mb-1">
                                <span className="text-base font-medium text-gray-700 dark:text-gray-300">Node.js | Express | rest API</span>
                        ...
                        <div>
                            <div className="flex justify-between mb-1">
                                <span className="text-base font-medium text-gray-700 dark:text-gray-300">HTML | CSS | Tailwind CSS</span>
                        ...
                        <div>
                            <div className="flex justify-between mb-1">
                                <span className="text-base font-medium text-gray-700 dark:text-gray-300">MongoDB</span>
                        ...
                        <div>
                            <div className="flex justify-between mb-1">
                                <span className="text-base font-medium text-gray-700 dark:text-gray-300">Git & GitHub | Framer motion | Firebase Authentication & others</span>
