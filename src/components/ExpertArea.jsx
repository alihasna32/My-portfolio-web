    ...
    return (
        <div className="bg-gray-500/10 shadow-[inset_1px_1px_15px_rgba(155,155,155,0.1)] backdrop-blur-sm border border-white/10 shadow-lg p-6 rounded-lg">
            ...
            <div className="grid grid-cols-3 gap-4">
                <div className="flex flex-col items-center justify-center p-3  rounded-lg border border-gray-600/100">
                ...
                <div className="flex flex-col items-center justify-center p-3  rounded-lg border border-gray-600/100">
                    ...
                    <p className="text-sm text-gray-300">Tailwind</p>
                </div>
                <div className="flex flex-col items-center justify-center p-3  rounded-lg border border-gray-600/100">
                ...
                <div className="flex flex-col items-center justify-center p-3  rounded-lg border border-gray-600/100">
                    ...
                    <p className="text-sm text-gray-300">Framer</p>
                </div>
            </div>
        </div>
    );
